...
![Dashboard Final](assets/05_painel_finalizado.png)
...
![Receita por País](assets/01-receita_por_pais.png)

---

### 2️⃣ Consulta SQL - Sales

![Consulta SQL](assets/02-consulta-fact-salesquota.png.png)

---

### 3️⃣ Receita Geral

![Receita](assets/02-receita.png)

---

### 4️⃣ Consulta SQL - Internet Sales

![Consulta Internet](assets/03-consulta-fact-internet-sales.png)

---

### 5️⃣ Vendas por Categoria

![Categoria](assets/03-pizza_por_categoria.png)

---

### 6️⃣ Criação de View SQL

![View SQL](assets/04-create-view-analise-vendas.png)

---

### 7️⃣ Distribuição por Gênero

![Gênero](assets/04-pizza_genero.png)

---

### 8️⃣ Validação dos Dados

![Validação](assets/05-validacao-view.png)

---

### 9️⃣ Vendas por Categoria (Barras)

![Categoria Barras](assets/06-vendas-por-categoria.png)

---

### 🔟 Evolução de Receita por Mês

![Receita por Mês](assets/07-receita-por-mes.png)

---

### 1️⃣1️⃣ Receita vs Custo por País

![Receita vs Custo](assets/08-receita-custo-por-pais.png)

---

### 1️⃣2️⃣ Vendas por Gênero

![Vendas por Sexo](assets/09-vendas-por-sexo.png)
